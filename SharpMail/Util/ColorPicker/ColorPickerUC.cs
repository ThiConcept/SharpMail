...
namespace Tibo.fr.SharpMail.Util.ColorPicker
{
    ...
    #region ColorPickerUC

    public class ColorPickerUC : Control
    {


        static ColorPickerUC()
        {
            DefaultStyleKeyProperty.OverrideMetadata(typeof(ColorPickerUC), new FrameworkPropertyMetadata(typeof(ColorPickerUC)));
        }
        ...
        public static readonly DependencyProperty SelectedColorProperty =
            ...
            ("SelectedColor", typeof(System.Windows.Media.Color), typeof(ColorPickerUC),
        ...
        public static readonly DependencyProperty ScAProperty =
               ...
               DependencyProperty.Register
               ("ScA", typeof(float), typeof(ColorPickerUC),
        ...
        public static readonly DependencyProperty ScRProperty =
              DependencyProperty.Register
              ("ScR", typeof(float), typeof(ColorPickerUC),
              new PropertyMetadata((float)1,
        ...
        public static readonly DependencyProperty ScGProperty =
              DependencyProperty.Register
              ("ScG", typeof(float), typeof(ColorPickerUC),
              new PropertyMetadata((float)1,
        ...
        public static readonly DependencyProperty ScBProperty =
              DependencyProperty.Register
              ("ScB", typeof(float), typeof(ColorPickerUC),
              new PropertyMetadata((float)1,
        ...
        public static readonly DependencyProperty AProperty =
              DependencyProperty.Register
              ("A", typeof(byte), typeof(ColorPickerUC),
        ...
        public static readonly DependencyProperty RProperty =
            DependencyProperty.Register
            ("R", typeof(byte), typeof(ColorPickerUC),
            new PropertyMetadata((byte)255,
        ...
        public static readonly DependencyProperty GProperty =
            DependencyProperty.Register
            ("G", typeof(byte), typeof(ColorPickerUC),
            new PropertyMetadata((byte)255,
        ...
        public static readonly DependencyProperty BProperty =
            DependencyProperty.Register
            ("B", typeof(byte), typeof(ColorPickerUC),
            new PropertyMetadata((byte)255,
        ...
        public static readonly DependencyProperty HexadecimalStringProperty =
            DependencyProperty.Register
            ("HexadecimalString", typeof(string), typeof(ColorPickerUC),
        ...
        {
            ColorPickerUC c = (ColorPickerUC)d;
        ...
        private static void selectedColor_changed(DependencyObject d,
            DependencyPropertyChangedEventArgs e)
        {
            ColorPickerUC cPicker = (ColorPickerUC)d;
